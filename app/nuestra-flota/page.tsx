  ...
  const fleet = [
    {
      ...
      features: ["Capacidad 40-50 pasajeros", "Aire acondicionado", "Asientos cómodos"],
    },
    {
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=400",
      features: ["Servicio ejecutivo", "Disponibilidad 24/7", "Confort premium"],
      badge: "ECO",
    },
  ]
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-700 mb-12 max-w-4xl">
            Conoce nuestra moderna flota de vehículos, diseñada para brindar el mejor servicio de transporte con
            tecnología de vanguardia y compromiso con la sustentabilidad.
          </p>

          {/* Fleet Grid */}
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
            {fleet.map((vehicle, index) => (
              <Card key={index} className="cursor-pointer hover:shadow-lg transition-all duration-300 relative">
                {vehicle.badge && (
                ...
                <CardContent className="p-0">
                  ...
                  />
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-blue-600 mb-2">{vehicle.title}</h3>
                    ...
                    <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white">Conoce más</Button>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="mt-16 bg-blue-50 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-blue-600 text-center mb-8">Nuestra Flota en Números</h2>
            ...
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-orange-500 mb-2">2030</div>
          ...
          <div className="mt-16 text-center">
            <h2 className="text-2xl font-bold text-blue-600 mb-4">¿Necesitas un servicio de transporte?</h2>
